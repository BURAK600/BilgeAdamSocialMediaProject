...
import static com.burak.exception.ErrorType.USERNAME_DUBLICATE;
...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity<ErrorMessage> handleMonolitichException(UserProfileServiceException ex) {
